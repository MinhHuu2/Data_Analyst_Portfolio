...
## Giới thiệu bản thân
Tôi tốt nghiệp ngành Toán học tại Trường Đại học Khoa học Tự nhiên Hà Nội và hiện đang tiếp tục phát triển sự nghiệp trong lĩnh vực Data với vị trí Chuyên viên Phân tích Dữ liệu. Với nền tảng vững chắc về Thống kê, tôi có kinh nghiệm sử dụng các công cụ như SQL, Python và Excel để xử lý, phân tích và trực quan hóa dữ liệu, hỗ trợ ra quyết định và tối ưu hóa quy trình làm việc.
...
## Table of Contents
- [About](https://github.com/MinhHuu2/Data_Analyst_Portfolio/blob/main/README.md#about)
- [Portfolio Projects](https://github.com/MinhHuu2/Data_Analyst_Portfolio/edit/main/README.md#portfolio-projects)
  - Python
